...
class Campaign(Base):
    ...
    currency: Mapped[str] = mapped_column(String(3), nullable=False)  # "KZT", "USD", ...
    ...
    # В БД храните object key, НЕ URL
...
class Investment(Base):
    ...
    __table_args__ = (
        Index("ix_investment_campaign_user", "campaign_id", "user_id"),
    )
...
class Payment(Base):
    ...
    provider: Mapped[str] = mapped_column(String(50), nullable=False)  # "kassa24", "stripe", "stub"
