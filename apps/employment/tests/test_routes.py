...
async def test_tg_check_creates_or_updates(monkeypatch):
    ...
    monkeypatch.setattr(routes.EmploymentService, "tg_check", AsyncMock(return_value=SimpleNamespace(telegram_id="1", is_blocked=False, linked_user_id=None, linked_candidate_id=1)))
